...
# Paths
KERNEL_DIR=`pwd`
RESOURCE_DIR="/home/kirito9/android/kernel/982t"
ANYKERNEL_DIR="$RESOURCE_DIR/BT-982t-AnyKernel2"
REPACK_DIR="$ANYKERNEL_DIR"
ZIP_MOVE="$RESOURCE_DIR/BT-releases/982t/"
ZIMAGE_DIR="$KERNEL_DIR/out/target/product/mts982t/obj/KERNEL_OBJ/arch/arm/boot"
